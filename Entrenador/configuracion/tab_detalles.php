...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['guardar_detalles'])) {
    ...
    $stmt = $conn->prepare("SELECT ID_USUARIO FROM tab_deportistas WHERE CEDULA_DEPO = :cedula_depo");
    ...
    if ($resultado) {
        ...
        $stmt = $conn->prepare("INSERT INTO tab_detalles (ID_USUARIO, NUMERO_CAMISA, ALTURA, PESO, FECHA_INGRESO) VALUES (:id_usuario, :numero_camisa, :altura, :peso, :fecha_ingreso)");
...
<body>
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
        ...
        <input type="hidden" name="cedula_depo" value="<?= $cedula_depo ?>">
