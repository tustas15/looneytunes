...
if (!isset($_SESSION['user_id']) || empty($_SESSION['user_id'])) {
    echo '
        <div class="notification is-danger is-light">
            ...
            No se ha iniciado sesión o la sesión ha expirado.
        </div>
    ';
    exit();
}
...
$guardar_producto = $guardar_producto->prepare("INSERT INTO tab_productos (producto_codigo, producto_nombre, producto_precio, producto_stock, producto_foto, id_categoria_producto, ID_USUARIO) VALUES (:codigo, :nombre, :precio, :stock, :foto, :categoria, :usuario)");
...
$marcadores = [
    ...
    ":foto" => $foto,
    ":categoria" => $categoria,
    ":usuario" => $_SESSION['user_id'] // Asegúrate de que esta variable esté correctamente definida
];
