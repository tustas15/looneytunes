            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="Usuarios/crear_usuarios/cradmin.php">
                            <i class="fas fa-user-shield"></i> <!-- Icono para Administradores -->
                            Administradores
                        </a>
                        <a class="collapse-item" href="busqueda/indexentrenador.php">
                            <i class="fas fa-user-tie"></i> <!-- Icono para Entrenadores -->
                            Entrenadores
                        </a>
                        <a class="collapse-item" href="busqueda/indexrepresentante.php">
                            <i class="fas fa-user"></i> <!-- Icono para Representantes -->
                            Representantes
                        </a>
                        <a class="collapse-item" href="busqueda/indexdeportista.php">
